...
import { MapPin, Search, AlertCircle, ShoppingBag, ArrowRight } from 'lucide-react';
import { Link } from 'react-router-dom';

const GiProductsSection = () => {
  ...
  return (
    <section id="giproducts" className="py-24 bg-[var(--bg-secondary)] relative overflow-hidden">
      {/* Decorative Orbs */}
      ...
      <div className="max-w-7xl mx-auto container-padding relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--bg)] border border-[var(--border)] rounded-full mb-4">
            <ShoppingBag className="w-4 h-4 text-primary" />
            <span className="text-sm font-medium">New Feature</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Geographical Indications (GI)</h2>
          <p className="text-[var(--text-secondary)] max-w-2xl mx-auto text-lg">
            Explore the unique and culturally significant GI products of Bangladesh. 
            From the legendary Jamdani textile to the sweet Fasli Mango.
          </p>
        </motion.div>
        ...
        {!loading && !error && filteredProducts.length > 0 && (
          ...
          >
            <Link to="/gi-products" className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-white rounded-full font-semibold hover:bg-primary-light transition-colors shadow-lg shadow-primary/30 group">
              Show All GI Products
...
export default GiProductsSection;
